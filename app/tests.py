  ...
  #def test_save_bond(self,code= 'Test17102017',circular='NULL', designation= 'test17102017', symbol = 'Test17102017',currency = 'LBP', subtype= 'ADVANCES TO CLIENTS', category = 'CIFs', trading_categor = 'Funds', nature = 'Carrier', trading_center = 'IRAQ', nationality = 'CHINA', deposit_place = 'BLOM', quotation_place = 'HONG KONG', asset_allocation = 'Net Hybrid Investments', group_for_ledgers = '4211', general_ledger = '4649', provider_code = 'provcode', provider_ratelist = 'Currency', multiplier_for_online_prices = 1, isin = 'isin', fixing = 'NULL', fix1 = '10:00', fix2 = '11:00', mar_short_position = 11, mar_lng_position = 12, main_short_position = 13, main_lng_position = 14, moody = 'aaa', fitch = 'bbb', s_and_p = 'ccc'):
   ...
   # if currency.code_leb=='':
    ...
    def test_save_bond_fail(self):
        ...
        designation= 'test17',
        symbol = 'Test17',
        currency = Currency.objects.create(name='cur', code_leb='l1', code_dub=None),
        subtype= Subtype.objects.create(name='sb', code_leb='l2', code_dub=None),
        category = Category.objects.create(name='ct', code_leb='l2', code_dub=None),
        trading_category = TradingCategory.objects.create(name='tcat', code_leb='l4', code_dub=None),
        nature = Nature.objects.create(name='nt', code_leb='l5', code_dub=None),
        trading_center = TradingCenter.objects.create(name='trct', code_leb='l6', code_dub=None),
        nationality = Nationality.objects.create(name='nlty', code_leb='l7', code_dub=None),
        deposit_place = DepositPlace.objects.create(name='Dpp', code_leb='l8', code_dub=None),
        quotation_place = QuotationPlace.objects.create(name='QP', code_leb='l9', code_dub=None),
        asset_allocation = AssetAllocation.objects.create(name='AsA', code_leb='l10', code_dub=None),
        group_for_ledgers = '4211',
        general_ledger = '4649',
        provider_code = 'pro',
        provider_ratelist = RateListProvider.objects.create(name='rlp', code_leb=11, code_dub=None),
        ...
        with self.assertRaises(ValueError):
          sec.checkAllDropdownsOnBothLebDub()


    def test_save_bond_pass(self):
    ...
    def test_save_bond_fail_on_missing_subtype(self):
