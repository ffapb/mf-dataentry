...
class MfManager:
  ...
  def insertSecurity(self):
    self.execute("INSERT INTO TITRE  (TIT_COD  ,TIT_CIR   ,TIT_NOM  ,TIT_DEV_COD  ,TIT_TYP_TIT_COD  ,TIT_STY_COD  ,TIT_NAT_TIT_COD  
 ,TIT_CAT_COD  ,TIT_MAR_COD  ,TIT_NAT_COD  ,TIT_PCE_COD  ,TIT_DEP_COD  ,TIT_LST_COD  ,TIT_FIXING  ,TIT_FIX_1  ,TIT_FIX_2  ,TIT_FRAIS  ,TIT_FR1  ,TIT_FR1_FFA  ,TIT_FR1_DEP  ,TIT_FR2  ,TIT_FR2_FFA   ,TIT_FR2_DEP  ,TIT_FR3  ,TIT_FR3_FFA  ,TIT_FR3_DEP  ,TIT_FR4  ,TIT_FR4_FFA  ,TIT_FR4_DEP  ,TIT_FR5  
 ,TIT_FR5_FFA  ,TIT_FR5_DEP  ,TIT_OCCUPE  ,TIT_O_MOD_COD  ,TIT_SHOW  ,TIT_HOLDER  ,TIT_OPTIONS  ,TIT_NB_UNITE  ,TIT_DAT_MAT  ,TIT_SEQ  ,TIT_FR1_FFACPT  ,TIT_FR1_DEPCPT  ,TIT_FR2_FFACPT  ,TIT_FR2_DEPCPT  ,TIT_FR3_FFACPT  ,TIT_FR3_DEPCPT  ,TIT_FR4_FFACPT ,TIT_FR4_DEPCPT  ,TIT_FR5_FFACPT ,TIT_FR5_DEPCPT  ,TIT_CHART_ACC  ,TIT_REU_COD  ,TIT_DIV_CHART  ,TIT_MAR  ,TIT_MAR_LN   ,TIT_MAR_SH  ,TIT_UPD  ,TIT_STRIKE  ,TIT_UNDERLYING  ,TIT_PUT  ,TIT_CALL  ,TIT_FUTUR  ,TIT_DEV_COD2  ,TIT_ISIN_COD  ,Tit_dep_Ref  ,TIT_DEV_COD1  ,TIT_ISSUER  ,TIT_DESC  ,TIT_RATIO  ,TIT_CATEG  ,TIT_TRADING_CATEG  ,TIT_RATE_LIST  ,Tit_Asset_Cod  ,TIT_FORWARD  ,TIT_FWD_SPOT,TIT_TREATED_ONLINE  ,TIT_FIRST_NOTICE_DAT  ,TIT_PIP_VALUE  ,TIT_ONLINE_RATE_MULTIPLIER  ,TIT_MAR_DEV  ,TIT_MONITOR_TYPE  ,TIT_CR_RATE1  ,TIT_CR_RATE2  ,TIT_CR_RATE3  ,TIT_TTG_COD  ,TIT_MAR_LN_MC  ,TIT_MAR_SH_MC  ,TIT_UPD_LOGIN  ,TIT_UPD_ACTION  ,TIT_UPD_LAST_DATE  ,TIT_TICKET_PROVIDER_CODE  ,TIT_TICKET_PROVIDER_SYMBOL ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)")
